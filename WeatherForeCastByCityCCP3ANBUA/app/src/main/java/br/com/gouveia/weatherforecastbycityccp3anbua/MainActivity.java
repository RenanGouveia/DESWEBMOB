        ...
        protected void onPostExecute(String json) {
            ...
            try{
                ...
                for(int i =0; i <list.length(); i++){
                    ...
                    String description = previsao.getJSONArray("weather").getJSONObject(0).getString("description");
                    String icon = previsao.getJSONArray("weather").getJSONObject(0).getString("icon");
